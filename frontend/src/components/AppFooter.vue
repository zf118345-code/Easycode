...
<template>
    <footer class="app-footer">
        ...
        <div class="footer-center">
            <span class="panel-status" @click="dialogVisible = true">
        ...
        <div class="footer-right">
            <div class="footer-tab-btn"
                 :class="{ 'is-active': store.minimapExpanded }"
                 @click="store.toggleMinimap">
                <span>🗺️ 全景导航</span>
            </div>
            <div class="footer-tab-btn"
                 :class="{ 'is-active': store.logExpanded }"
                 @click="store.toggleLogPanel">
                <span>📝 运行日志</span>
            </div>
...
<script setup>
    ...
    const currentProject = computed(() => store.currentProjectName || '未选择')
