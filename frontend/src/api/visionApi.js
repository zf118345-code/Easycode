...
export const visionApi = {
    ...
    testOcr: (projectPath, regionValue, grayScale, grayThreshold, imageSource) => client.post('/api/ocr/test', { project_path: projectPath, region_value: regionValue, gray_scale: grayScale, gray_threshold: grayThreshold, image_source: imageSource }),
