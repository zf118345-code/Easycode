...
PARAM_DEFINITIONS: dict[str, dict[str, Any]] = {
    'page_state': {
        ...
        'params': {
            ...
            'page_name': {'type': 'str', 'label': '页面名称', 'default': '', 'placeholder': '如：商城页'},
            ...
            'features': {
                ...
                'sub': {
                    ...
                    'params': {
                        ...
                        'default': {},
                        'sub': {
                            'template': {'type': 'file', 'label': '模板图片(image_exists)', 'default': ''},
                            'text': {'type': 'str', 'label': '文本内容(text_contains)', 'default': ''},
                            'region': {
                                'type': 'str',
                                'label': '识别区域(x,y,w,h)',
                                'default': '',
                            ...
                            'threshold': {'type': 'slider', 'label': '匹配置信度', 'default': 0.8, 'min': 0, 'max': 1},
                        },
                    },
                    ...
                    'negate': {'type': 'bool', 'label': '结果取反', 'default': False},
                },
            },
            ...
            'exits': {
                ...
                'sub': {
                    ...
                    'target_page_id': {'type': 'str', 'label': '目标页面 ID', 'default': ''},
                    'transition_conditions': {'type': 'condition_list', 'label': '过图前置条件', 'default': []},
                },
            },
        },
    }
