...
object AndroidPackagePreflight {
    ...
    private val supportedOpcodes = setOf(
        ...
        "target.wait_online", "target.status", "target.capture_frame", "frame.save", "frame.crop_region", "host.app.start",
        "clipboard.read_text", "clipboard.write_text",
        "color.read", "color.find", "vision.find", "vision.find_all", "vision.compare_samples", "text.recognize", "standard.image.wait_visible",
